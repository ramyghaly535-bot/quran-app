...
const RECITER_LIBRARY = [
  ...
  { id: 11, name: 'ناصر القطبي', folder: 'ketbi', server: 'server6', readId: 11, url: 'https://server6.mp3quran.net/ketbi/{num}.mp3', rewaya: 'حفص عن عاصم', hasTiming: true },
  ...
  { id: 19, name: 'سعيد أبو عونة', folder: 'aboona', server: 'server6', readId: 17, url: 'https://server6.mp3quran.net/aboona/{num}.mp3', rewaya: 'حفص عن عاصم', hasTiming: true },
  ...
  { id: 36, name: 'صلاح الفوزان', folder: 'fawzan', server: 'server10', readId: null, url: 'https://server10.mp3quran.net/fawzan/{num}.mp3', rewaya: 'حفص عن عاصم', hasTiming: false },
  ...
  { id: 86, name: 'عبدالرحمن السويّد', folder: 'a_swaiyd', server: 'server16', readId: 135, url: 'https://server16.mp3quran.net/a_swaiyd/Rewayat-Hafs-A-n-Assem/{num}.mp3', rewaya: 'حفص عن عاصم', hasTiming: true },
